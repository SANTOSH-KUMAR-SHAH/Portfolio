...
const ElasticHueSlider: React.FC<ElasticHueSliderProps> = ({
    ...
    return (
        <div className="scale-75 relative w-full max-w-xs flex flex-col items-center" ref={sliderRef}>
            {label && <label htmlFor="hue-slider-native" className="text-gray-400 text-xs mb-2 uppercase tracking-widest">{label}</label>}
        ...
        <div className={`absolute ${position} z-10 group transition-all duration-300 hover:scale-110`}>
            <div className="flex items-center gap-2 relative">
                ...
                <div className=" text-white relative">
                    ...
                    <div className="text-white/70 text-sm group-hover:text-white/70 transition-colors duration-300 whitespace-nowrap">{value}</div>
    ...
    return (
        <div className="relative w-full h-screen bg-black text-white overflow-hidden flex flex-col items-center justify-center">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute top-[55%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] rounded-full bg-gradient-to-b from-primary/20 to-secondary/10 blur-[120px]"></div>
                ...
                <div className="z-10 absolute top-[55%] left-1/2 transform -translate-x-1/2 w-[600px] h-[600px] backdrop-blur-[100px] rounded-full bg-[radial-gradient(circle_at_25%_90%,_#0a192f_15%,_#000000_70%)] border border-white/5 opacity-80"></div>
            </div>
            ...
            <div className="relative z-20 w-full max-w-7xl mx-auto px-4 text-center">
                ...
                >
                    ...
                    <motion.h2
                        variants={itemVariants}
                        className="text-2xl md:text-4xl font-light text-gray-400 max-w-2xl"
                    >
                        Where code meets creativity in a symphony of light.
                    </motion.h2>

                    <motion.div variants={itemVariants} className="mt-12">
                        <button
                            onClick={() => document.getElementById('work')?.scrollIntoView({ behavior: 'smooth' })}
                            className="px-10 py-4 bg-white text-black font-bold rounded-full hover:bg-white/90 transition-all hover:scale-105"
                        >
                            Explore the Galaxy
                        </button>
                    </motion.div>
                ...
                >
                    <FeatureItem name="React" value="Base Engine" position="left-[10%] top-[30%]" />
                    <FeatureItem name="WebGL" value="Lightning" position="left-[15%] bottom-[30%]" />
                    <FeatureItem name="Framer" value="Fluid Motion" position="right-[10%] top-[35%]" />
                    <FeatureItem name="Tailwind" value="Style Layer" position="right-[15%] bottom-[35%]" />
                </motion.div>
            </div>
        </div>
    );
