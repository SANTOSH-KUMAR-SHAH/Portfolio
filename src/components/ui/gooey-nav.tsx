...
const GooeyNav: React.FC<GooeyNavProps> = ({
    ...
    const updateEffectPosition = (element: HTMLElement) => {
        ...
        textRef.current.innerText = (element as any).innerText || "";
    };

    const handleClick = (e: React.MouseEvent<HTMLAnchorElement>, index: number) => {
        const liEl = (e.currentTarget as any).parentElement;
        ...
        if (filterRef.current) {
            filterRef.current.classList.remove('animate-pill');
            void filterRef.current.offsetWidth;
            filterRef.current.classList.add('animate-pill');
