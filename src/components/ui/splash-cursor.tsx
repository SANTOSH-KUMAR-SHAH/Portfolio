...
const SplashCursor: React.FC<SplashCursorProps> = ({
    ...
    }, [BACK_COLOR, CAPTURE_RESOLUTION, COLOR_UPDATE_SPEED, CURL, DENSITY_DISSIPATION, DYE_RESOLUTION, PRESSURE, PRESSURE_ITERATIONS, SIM_RESOLUTION, SHADING, SPLAT_FORCE, SPLAT_RADIUS, TRANSPARENT, VELOCITY_DISSIPATION]);
